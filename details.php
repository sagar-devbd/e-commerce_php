...
<body>
    ...
    <div id="content"><!-- #content Begin -->
        ...
        <div class="container"><!-- container Begin -->
            ...
            <!---------X-------- START PRODUCT CAROUSEL & DETAILS ---------X---------->
            ...
            <div class="col-md-9"><!-- col-md-9 Begin -->
                            ...
                            <div id="myCarousel" class="carousel slide" data-ride="carousel"><!-- carousel slide Begin -->
                                ...
                                <div class="carousel-inner">
                                    ...
                                    <div class="item active">
                                        ...
                                        <center><img class="img-responsive" src="products_images/Product-4.jpg" alt="Product 4-a"></center>
                                    
                                    </div>

                                    <div class="item">
                                    
                                        <center><img class="img-responsive" src="products_images/Product-details-2.png" alt="Product 4-b"></center>
                                    
                                    </div>

                                    <div class="item">
                                    
                                        <center><img class="img-responsive" src="products_images/Product-details-3.png" alt="Product 4-c"></center>
                        ...
                        <div class="row" id="thumbs"><!-- row Begin -->
                            ...
                            <div class="col-xs-4"><!-- col-xs-4 Begin -->
                                ...
                                <a data-target="#myCarousel" data-slide-to="0" href="#" class="thumb"><!-- thumb Begin -->
                                    ...
                                    <img src="products_images/Product-4.jpg" alt="Product 4" class="img-responsive"> 
                            ...
                            <div class="col-xs-4"><!-- col-xs-4 Begin -->
                                ...
                                <a data-target="#myCarousel" data-slide-to="1" href="#" class="thumb"><!-- thumb Begin -->
                                    ...
                                    <img src="products_images/Product-details-2.png" alt="Product 2a" class="img-responsive"> 
                            ...
                            <div class="col-xs-4"><!-- col-xs-4 Begin -->
                                ...
                                <a data-target="#myCarousel" data-slide-to="2" href="#" class="thumb"><!-- thumb Begin -->
                                    ...
                                    <img src="products_images/Product-details-3.png" alt="Product 2b" class="img-responsive"> 
                ...
                <div class="box" id="details"><!-- box Begin -->
                    ...
                    <p>
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vero animi, harum amet eveniet quod maiores iste perferendis. Ut in recusandae, nisi assumenda sit eligendi ipsa, incidunt culpa necessitatibus, praesentium cumque!
                    </p>
            ...
            <!---------X-------- CLOSE PRODUCT CAROUSEL & DETAILS ---------X---------->
